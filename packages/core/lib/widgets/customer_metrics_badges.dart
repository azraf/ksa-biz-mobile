  ...
  Widget build(BuildContext context) {
    return Wrap(
      ...
      children: [
        ...
        _chip(metrics.frequencyLabel, Colors.blue.shade50, Colors.blue.shade800),
        if (metrics.paymentReliabilityEffective != null &&
            metrics.paymentReliabilityEffective != 'unknown')
          _chip(metrics.paymentLabel, Colors.green.shade50, Colors.green.shade800),
        if (!compact && metrics.avgDaysBetweenOrders != null)
          Text(
            '~every ${metrics.avgDaysBetweenOrders!.round()} days',
