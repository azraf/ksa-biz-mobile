    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          ...
          _tile(context, 'Purchases', Icons.shopping_cart, '/shipping/purchases'),
          _section(context, 'Expenses'),
          _tile(context, 'Expense Categories', Icons.account_tree, '/expenses/categories'),
          _tile(context, 'Expenses', Icons.payments, '/expenses/list'),
          _tile(context, 'Vehicles', Icons.directions_car, '/expenses/vehicles'),
          ...
          _tile(context, 'Expense Report', Icons.pie_chart, '/reports/expenses'),
          _tile(context, 'Expense Summary', Icons.summarize, '/reports/expense-summary'),
