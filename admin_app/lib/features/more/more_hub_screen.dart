      ...
      children: [
        ...
        _section(context, 'Reports', [
          ...
          _tile(
            ...
            'Expense Report',
            Icons.pie_chart,
            '/more/reports/expenses',
          ),
          _tile(
            context,
            'Expense Summary',
            Icons.summarize,
            '/more/reports/expense-summary',
          ),
        ]),
        _section(context, 'Expenses', [
          ...
          _tile(
            ...
            'Expense Categories',
            Icons.account_tree,
            '/more/expenses/categories',
          ),
          _tile(
            context,
            'Vehicles',
            Icons.directions_car,
            '/more/expenses/vehicles',
          ),
        ]),
        _section(context, 'Catalog', [
          _tile(
            ...
            'Products',
            Icons.inventory_2,
            '/more/catalog/products',
          ),
          _tile(
            context,
            'Categories',
            Icons.category,
            '/more/catalog/categories',
          ),
