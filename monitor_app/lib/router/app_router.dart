          ...
          StatefulShellBranch(
            routes: [
              GoRoute(
                ...
                routes: [
                  GoRoute(path: 'sales', builder: (_, __) => const SalesReportScreen()),
                  GoRoute(path: 'profit', builder: (_, __) => const ProfitReportScreen()),
                  GoRoute(path: 'expenses', builder: (_, __) => const ExpenseReportScreen()),
                  GoRoute(
                    path: 'expense-summary',
                    builder: (_, __) => const ExpenseSummaryReportScreen(),
                  ),
                  GoRoute(path: 'map', builder: (_, __) => const MonitorLocationMapScreen()),
                ],
              ),
            ],
          ),
