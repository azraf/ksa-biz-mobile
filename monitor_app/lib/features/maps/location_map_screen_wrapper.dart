...
/// Same filter/sort/search drawer as sales_app's Field Map and admin_app's
/// location map, plus a multi-select sales person filter (monitor sees every
/// rep's book, not just one).
